...
/**
  ...
  */
/*object PolynomialOverFieldBetter extends PolynomialOverRingBetter {

  def apply(field: Fp): PolynomialOverFieldBetter = {
    new PolynomialOverFieldBetter(field)
  }
}*/
...
/**
  * builder of a Polynomial Ring over field
  */
class PolynomialOverFieldBetter private(val field: Field) extends PolynomialOverRingBetter{
  ...
  class Polynomial private(val map: T1)  {
    ...
    val fatherPolynomialOverFieldBetter = PolynomialOverFieldBetter.this
